...
public class Auth0tokenGateway {
    private static final String AUDIENCE = "https://mzaragoza.us.auth0.com/api/v2/";
    private static final String GRANT_TYPE = "client_credentials";
    private static final String TOKEN_URL = "https://mzaragoza.us.auth0.com/oauth/token";
 ...
 */
    ...
    public synchronized Auth0token getToken() {
        // if token is null or has expired -> update token, else return curr token
        currToken = Optional.ofNullable(currToken).filter(t -> !expired(t)).orElseGet(this::fetchToken);
        return currToken;
    }
    ...
    public Auth0token fetchToken() {
        ...
        return new RestTemplate().postForObject(TOKEN_URL, entity, Auth0token.class);
    }

    public static void main(String[] args) throws ParseException {
//        Auth0tokenGateway gateway = new Auth0tokenGateway("slsHDC12Kyy9tayuDjVue7JIt0GG3y6U", "DmGykhz6D6HQULM9_I_Imbnl-MO2nNp0nEsirx-e498YnJMfMIY-W1HMPU4RNDFE");
